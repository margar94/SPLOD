...
itLanguageManager.prototype.labels = {'type' : 'tipo',
		'seeAlso' : 'vedi anche',
		'sameAs' : 'uguale a',
		'subject' : 'argomento',
		'label' : 'etichetta',
		...
		'isPrimaryTopicOf' : 'argomento principale di',
		'language' : 'lingua',
		'abstract' : 'sommario',
		'comment' : 'commento',
		'name' : 'nome',
		...
		'HistoricalAreaOfAuthority' : 'area storia dell\'autorità',
		'Employer' : 'impiegato',
		'Family' : 'famiglia',
		...
		'Thing' : 'cosa',
		'EducationalInstitution' : 'istituzione educative',
		...
		'Drama' : 'dramma',
		'Escalator' : 'scalatore',
		'GovernementAgency' : 'agenzia governamentale',
		'GivenName' : 'nome dato',
		'GeopoliticalOrganisation' : 'organizzazione geopolitica',
		'GeologicalPeriod' : 'periodo geologico',
		'FormulaOneRacing' : 'corse della formula 1',
		'FormulaOneRacer' : 'autisti della formula 1',
		'Municipality' : 'municipalità',
		'Forest' : 'foresta',
		'Flag' : 'bandiera',
		'FootballMatch' : 'partita di calcio',
		'Depth' : 'profondità'
		};
