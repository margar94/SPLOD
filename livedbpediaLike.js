...
livedbpediaLike.prototype.changeEndpoint = function (selectedEndpoint, selectedGraph) {
	endpoint = selectedEndpoint;
	graph = selectedGraph;
}

/*livedbpediaLike.prototype.changeLanguage = function (selectedLanguage) {
...
function addInstancesOccurenceClassHierarchy(arrayData, map){
	...
	$.each(arrayData, function(index){
		...
		/*else{
			console.log("livedbpediaLike : " + element.class.value + " not in map");
		}*/
	});
	return map; 
}
